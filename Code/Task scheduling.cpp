...
// const int tasksNumber = 10; //Example 1 , 2.
const int tasksNumber = 20; // Example 3, 4, 5
...
void printAssignment(const vector<Task> &tasks, const vector<int> &wirelessQueue,
    ...
    // Set the maximum timeline to 30 or 50
    maxTimeline = max(maxTimeline, 50);
...
int main() {
    ...
    // Print Time
    cout << "Execution Time for Initial Scheduling: " << duration.count() << " microsec.\n" << endl;
    ...
    cout << "Final Scheduling Table: \n\n";
    printAssignment(tasks, wirelessSendQueue, cores, energyTotal, timeTotal);
    
    // Print Time
    cout << "Execution Time for Final Scheduling: " << finalDuration.count() << " microsec.\n" << endl;
    
    // Print comparison table
    cout << "----------- Energy-Time Table ---------- \n";
    cout << left << setw(20) << "Total" << setw(10) << "Initial" << setw(10) << "Final" << endl;
    cout << string(40, '-') << endl;
